...
//	Faça uma calculadora especial que tenha as operações abaixo implementadas.
//	Sua calculadora deverá ser organizada inteiramente com funções.
//	Como entrada a calculadora deverá receber vetores (conforme cada item abaixo)
//	de números inteiros e retornar a resposta para cada operação.
//	Obs: A entrada de parâmetros das funções (no caso os vetores passados como
//	parâmetros) e retorno de cada função faz parte da modelagem das funções
//	implementas.
//	Você deve popular os vetores que serão utilizados em cada item (1 a 22). Para
//	gerar os números de forma aleatória você pode utilizar o exemplo seguinte de
//	código que gera números aleatórios entre x e y:
//	int x=30
//	int y=150;
//	
...
//	informado;
//	Exemplo com dois grupos: Os elementos do vetor deverão ser ordenados
//	de forma ascendente. O programa deverá informar quais são os
//	elementos da primeira parte do vetor e quais são os elementos da
